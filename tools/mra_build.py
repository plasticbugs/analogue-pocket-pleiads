#!/usr/bin/env python3
"""Build the Pocket .rom image for the Pleiads core from a MAME romset.
...
MAME `pleiads` romset -- either the zip or a directory of loose files -- checks
...
Usage:
    ...
    mra_build.py pleiads.mra pleiads.zip
    mra_build.py pleiads.mra ~/roms/pleiads/
"""
...
def main():
    ...
    print('copy it to  Assets/pleiads/common/  on your Pocket SD card')
